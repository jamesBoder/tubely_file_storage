...
func main() {
	...
	// use config.LoadDefaultConfig to auto load the default AWS SDK config as args we give an empty Context and pass config.WithRegion(s3Region)
	...
	// debug print
	log.Printf("S3 configured: bucket=%s region=%s", s3Bucket, s3Region)
